...
- mkdocs internal links without extension: from `.md` files resolve to `.md` only (must include `.ipynb` for notebooks); from `.ipynb` files can resolve to `.md` or `.ipynb` (mkdocs-jupyter URL-style)
